...
register_sidebar( array(
	'name' => __( 'Services Box1', 'twentyten' ),
	'id' => 'services_box1',
	'description' => __( 'The primary widget area', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
...
register_sidebar( array(
	'name' => __( 'Services Box2', 'twentyten' ),
	'id' => 'services_box2',
	'description' => __( 'The primary widget area', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
...
register_sidebar( array(
	'name' => __( 'Services Box3', 'twentyten' ),
	'id' => 'services_box3',
	'description' => __( 'The primary widget area', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
...
register_sidebar( array(
	'name' => __( 'Services Box4', 'twentyten' ),
	'id' => 'services_box4',
	'description' => __( 'The primary widget area', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
...
register_sidebar( array(
	'name' => __( 'Bottom1 Box4', 'twentyten' ),
	'id' => 'bottom1_box4',
	'description' => __( 'The primary widget area', 'twentyten' ),
	'before_widget' => '<div class="widget-container %2$s">',
	'after_widget' => '</div>',
